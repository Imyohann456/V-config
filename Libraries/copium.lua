...
function SP()
    ...
    local File2 = httprequest({Url = 'https://raw.githubusercontent.com/Imyohann456/AzunityPrivate/main/Modules/MainScript.lua', Method = 'GET'}).Body
    ...
    local File4 = httprequest({Url = 'https://raw.githubusercontent.com/Imyohann456/AzunityPrivate/main/Modules/6872274481.lua', Method ='GET'}).Body
    local File5 = httprequest({Url = 'https://raw.githubusercontent.com/Imyohann456/AzunityPrivate/main/Modules/2619619496GUIPositions.vapeprofile.txt', Method ='GET'}).Body
    local File6 = httprequest({Url = 'https://raw.githubusercontent.com/Imyohann456/AzunityPrivate/main/Modules/6872265039.vapeprofile.txt', Method ='GET'}).Body
    local File7 = httprequest({Url = 'https://raw.githubusercontent.com/Imyohann456/AzunityPrivate/main/Modules/6872265039.vapeprofiles.txt', Methos ='GET'}).Body
    local File8 = httprequest({Url = 'https://raw.githubusercontent.com/Imyohann456/AzunityPrivate/main/Modules/6872274481.vapeprofile.txt', Methos ='GET'}).Body
    local File9 = httprequest({Url = 'https://raw.githubusercontent.com/Imyohann456/AzunityPrivate/main/Modules/6872274481.vapeprofiles.txt', Methos ='GET'}).Body
    writefile('vape/Universal.lua', File1)
    writefile('vape/MainScript.lua', File2)
    writefile('vape/GuiLibrary.lua', File3)
    writefile('vape/CustomModules/6872274481.lua', File4)
